...
export const _STAT_TO_BUFF: Record<string, keyof BuffCollection> = {
  ...
  projectile_explosion_dmg_pct: 'atk_dmg_pct',
  intercept_dmg_pct: 'atk_dmg_pct',
  dmg_scale_mag_pct: 'atk_dmg_pct',
  max_ammo_pct: 'max_ammo_pct',
  max_ammo_flat: 'max_ammo_flat',
  ammo_charge_pct: 'max_ammo_pct',
  ammo_charge_flat: 'max_ammo_flat',
  ...
  burst_charge_pct: 'burst_cooldown_pct',
  burst_charge_speed_pct: 'burst_cooldown_pct',
  burst_gauge_charge_speed_up: 'burst_cooldown_pct',
  skill_cooldown_pct: 'skill_cooldown_pct',
  lifesteal_pct: 'lifesteal_pct',
  outgoing_heal_pct: 'lifesteal_pct',
  max_hp_pct: 'max_hp_pct',
  hp_caster_based_pct: 'max_hp_pct',
  hp_only_caster_based_pct: 'max_hp_pct',
  def_pct: 'def_pct',
  def_up: 'def_pct',
