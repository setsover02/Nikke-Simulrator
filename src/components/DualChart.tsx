...
const DualChart: React.FC<Props> = ({ noCoreDatasets, withCoreDatasets, burstZones }) => {
    ...
    return (
        <div style={{ display: 'flex', gap: '24px', marginTop: '20px', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: '1', minWidth: '360px' }}>
                ...
                <CanvasChart datasets={noCoreDatasets} burstZones={burstZones} />
            </div>
            {/* 코어 있는 적 차트 */}
            <div style={{ flex: '1', minWidth: '360px' }}>
                ...
                <CanvasChart datasets={withCoreDatasets} burstZones={burstZones} />
            </div>
        </div>
    );
};
